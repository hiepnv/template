var JSNISInternalFolder = 
{
	...
	disableImageManager: function() {
		$('showlist-video-layout').style.display='none';
	},
	...
	ajaxCheckThumb: function(total, count , imageID)
	{
		...
		JSNISInternalFolder.listAjaxCheckThumb[count] = new Request({
			url: 'index.php?option=com_imageshow&controller=flex&task=checkThumb&image_id='+ imageID +'&total=' + total +'&count='+ count + '&rand=' + Math.random(),
			method: 'get',
			noCache: true,
			link: 'chain',
