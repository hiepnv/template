 ...
 * @version $Id: jsn_is_installer.php 8792 2011-10-06 03:40:05Z trungnq $
...
class JSNISInstaller extends JInstaller
{
	...
	function setAdapter($name, &$adapter = null, $options = Array())
	{
		...
		{
			require_once(JPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_imageshow'.DS.'adapters'.DS.strtolower($name).'.php');
