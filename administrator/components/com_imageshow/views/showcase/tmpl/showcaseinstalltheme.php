 ...
 * @version $Id: showcaseinstalltheme.php 11281 2012-02-19 14:05:48Z thangbh $
...
<div id="jsn-install-theme">
	<h3 class="jsn-element-heading"><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></h3>
	<form id="jsn-form-install-theme" enctype="multipart/form-data" action="index.php?option=com_imageshow&controller=showcase&task=showcaseinstalltheme" method="post" name="adminForm">
		...
		<div class="jsn-button-container"><button class="link-button" onclick="submitbutton(); return false;"><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></button></div>
