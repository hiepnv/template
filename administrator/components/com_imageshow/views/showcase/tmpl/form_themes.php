 ...
 * @version $Id: form_themes.php 11793 2012-03-19 10:45:42Z giangnd $
...
<div class="jsn-showcase-select-themes">
<h3 class="jsn-element-heading"><?php echo JText::_('SHOWCASE_INSTALL_SELECT_THEME'); ?></h3>
            			...
            			if ($rows->needUpdate)
						{
							if ($rows->authentication != true)
							{
								...
								if (!$this->canAutoDownload) {
									...
									$actionClass = ' jsn-showcase-theme-update modal ';
							...
							else
							{
								...
								$actionClass 	= ' modal jsn-showcase-theme-update ';
