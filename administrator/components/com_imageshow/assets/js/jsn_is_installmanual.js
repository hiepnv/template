...
var JSNInstallManual = new Class({
	...
	_formInstallJSNPlugin: function()
	{
		...
		html += '<div class="jsn-manual-installation"><ul><li>1. '+this.options.dowloadInstallationPackageText+': <a href="'+ this.options.downloadLink+ '" class="link-button">'+ this.options.manualDownloadText + '</a></li>';
		html += '<li>2. '+this.options.selectDownloadPackageText+': <input type="file" size="60" name="file"/></li></ul>';
		...
		html += '<div class="jsn-button-container"><button class="link-button" type="submit"/>'+ this.options.manualInstallButton +'</button></div>';
		html += '</div></div>';
	...
	_formUpdatePage: function()
	{
		...
		html += '<ul><li>1. '+this.options.dowloadInstallationPackageText+': <a href="'+ this.options.downloadLink+ '" class="link-button">'+ this.options.manualDownloadText + '</a></li>';
